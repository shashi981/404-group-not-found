...
public class HomeActivityMock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scanGroceriesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityLauncher.launchActivity(HomeActivityMock.this, ScannerActivity.class);
                finish();
        ...
        manageInventoryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ActivityLauncher.launchActivity(HomeActivityMock.this, InventoryActivity.class);
                finish();
        ...
        consultDietitianButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityLauncher.launchActivity(HomeActivityMock.this, UserListActivity.class);
                finish();
        ...
        suggestedRecipesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityLauncher.launchActivity(HomeActivityMock.this, RecipeActivity.class);
                finish();
...
//        });
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (id == R.id.settings_dropdown) {
                    ActivityLauncher.launchActivity(HomeActivityMock.this, SettingsActivity.class);

                    return true;
                } else if (id == R.id.profile_dropdown) {
                    ActivityLauncher.launchActivity(HomeActivityMock.this, ProfileActivity.class);
    ...
    private void setGreeting(){
        UserData userData = SharedPrefManager.loadUserData(HomeActivityMock.this);
