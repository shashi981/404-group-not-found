...
public class ProfilePageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userData = SharedPrefManager.loadUserData(ProfilePageActivity.this);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                for (String preference : loadPreferences) {
                    TextView preferenceTextView = new TextView(ProfilePageActivity.this);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (savePreferences.isEmpty()) {
                    dialog.dismiss();
                    ActivityLauncher.launchActivity(ProfilePageActivity.this, ProfilePageActivity.class);
                    finish();
                } else {
    ...
    private void setDetails(){
        UserData userData = SharedPrefManager.loadUserData(ProfilePageActivity.this);
