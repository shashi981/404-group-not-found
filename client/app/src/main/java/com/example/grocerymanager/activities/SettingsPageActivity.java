...
public class SettingsPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        userData = SharedPrefManager.loadUserData(SettingsPageActivity.this);
    ...
    private void declareDietitian() {
        ...
        UserData userData = SharedPrefManager.loadUserData(SettingsPageActivity.this);
        if (userData != null) {
    ...
    private void launchMainIntent() {
        Intent mainIntent = new Intent(SettingsPageActivity.this, MainActivity.class);
